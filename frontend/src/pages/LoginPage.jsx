    ...
    <div className="min-h-screen bg-slate-50 text-slate-900">
      <div className="mx-auto flex min-h-screen w-full max-w-7xl flex-col px-4 py-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-4 grid flex-1 gap-4 lg:grid-cols-[1.5fr_1fr] lg:gap-6">
          <section className="order-2 rounded-3xl border border-slate-200 bg-slate-100/70 p-6 sm:p-8 lg:order-1">
            ...
            <div className="mt-8 rounded-2xl border border-slate-200 bg-white/70 p-4 opacity-80 sm:p-5">
          ...
          <aside className="order-1 flex items-center justify-center lg:order-2">
            <section className="w-full max-w-md rounded-3xl border border-slate-200 bg-white p-6 shadow-[0_16px_40px_rgba(15,23,42,0.08)] sm:p-8">
              ...
              <form onSubmit={handleSubmit} className="mt-7 space-y-4">
                <label className="block">
                  ...
                  <span className="group relative flex h-12 items-center rounded-xl border border-slate-300 bg-white transition focus-within:border-blue-600 focus-within:ring-2 focus-within:ring-blue-100">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="inline-flex h-12 w-full items-center justify-center gap-2 rounded-xl bg-blue-600 px-4 text-sm font-semibold text-white transition hover:bg-blue-700 disabled:cursor-not-allowed disabled:opacity-60"
                >
